...
Para este modulo, no se maneja cola de mensajería
...
<div align="center">
<img src="docs/jacoco.png" alt="Jacoco" width="600"/>
</div>
...
<div align="center">
<img src="docs/ci.png" alt="CI" width="600"/>
</div>

El pipeline `.github/workflows/cd.yml` corre en cada push a `main`, `develop` o `feature/**`:
<div align="center">
<img src="docs/cd.png" alt="CD" width="600"/>
</div>
...
| Despliegue Azure | https://patriciaproject.slack.com/archives/D0B0G61S6J2/p1778712383271249|
